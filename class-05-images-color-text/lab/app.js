...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  var theSum = sum(a, b);
  var theSum2 = sum(theSum[0], c);
  var theProduct = multiply(a, b);
  var theProduct2 = multiply(theProduct[0], c);
  var sumMessage = a + ' and ' + b + ' and ' + c + ' sum to ' + theSum2[0] + '.';
  var productMessage = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + theProduct2[0] + '.';
  return [theSum2[0], theProduct2[0], sumMessage, productMessage];
}
...
function sumArray(testArray) { //eslint-disable-line
  ...
  // console.log(test2);
  var message4 = testArray + ' was passed in as an array of numbers, and ' + test2[0] + ' is their sum.';
  return [testArray, message4];
}
...
function multiplyArray(testArray) { //eslint-disable-line
  ...
  var b = testArray[1];
  var c = testArray[2];
  var test1 = multiply(a, b);
  var test2 = multiply(test1[0], c);
  var message5 = 'The numbers ' + testArray + ' have a product of ' + test2[0] + '.';
  return [testArray, message5];
}
